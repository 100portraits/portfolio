        ...
        <>
            <div className="max-w-screen-md md:max-w-screen-lg p-10 mx-auto">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3 h-[40vh] md'>
                    <Link to='/projects/portraits'><div className='bg-slate-100 h-full flex hover:bg-slate-200 group'>
                        <h1 className='text-2xl font-semibold m-10 group-hover:underline underline-offset-4'>
                            100portraits<FaExternalLinkAlt className='inline text-sm ml-2'/>
                        </h1>
                    </div></Link>
                    <Link to='/projects/toolkit'> <div className='bg-slate-100 h-full flex hover:bg-slate-200 group'>
                        <h1 className='text-2xl font-semibold m-10 group-hover:underline underline-offset-4'>
                            Innovative Education Toolkit<FaExternalLinkAlt className='inline text-sm ml-2'/>
                        </h1>
                    </div></Link>
