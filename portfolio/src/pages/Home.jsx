            ...
            <div className='dark:bg-slate-800'>
                <div className="min-h-screen dark:bg-slate-800 dark:text-white max-w-screen-md md:max-w-screen-lg p-10 mx-auto ">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-3 min-h-[40vh]'>
                        <Link to='/work'><div className='bg-slate-100 dark:bg-slate-700  h-full flex hover:bg-slate-200 group'>
                        ...
                        <Link to='/about'> <div className='bg-slate-100 dark:bg-slate-700 h-full flex hover:bg-slate-200 group'>
                            <h1 className='text-2xl font-semibold m-10 group-hover:underline underline-offset-4'>
                                About me<FaExternalLinkAlt className='inline text-sm ml-2'/>
                            </h1>
                        </div></Link>
                        <Link to='/projects'><div className='bg-slate-100 dark:bg-slate-700  h-full flex hover:bg-slate-200 group'>
                            <h1 className='text-2xl font-semibold m-10 group-hover:underline underline-offset-4'>
                                Projects<FaExternalLinkAlt className='inline text-sm ml-2'/>
                            </h1>
                        </div></Link>
                        <Link to='/blog'><div className='bg-slate-100 dark:bg-slate-700  h-full flex hover:bg-slate-200 group'>
                            <h1 className='text-2xl font-semibold m-10 group-hover:underline underline-offset-4'>
